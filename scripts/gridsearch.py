...
Usage:
  python3 scripts/gridsearch.py --T 65536 --C 1024 --n 4
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="One-shot grid search for mHC-lite Triton launch params")
    ...
    print("mHC-lite Triton grid search")
